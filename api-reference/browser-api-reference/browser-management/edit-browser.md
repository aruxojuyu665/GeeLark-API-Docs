...
> API Reference > Browser API Reference > Browser Management > Edit browser

**Source:** [https://doc.geelark.com/web/#/602813392/101528630](https://doc.geelark.com/web/#/602813392/101528630)
...
| accountPlatform | No | string | Account platform. Will not be changed if not passed. Only supports [https://www.tiktok.com/](https://www.tiktok.com/), [https://www.facebook.com/](https://www.facebook.com/) | [https://www.tiktok.com/](https://www.tiktok.com/) |
...
| openTabs | No | string | Opens the specified webpages. Separate multiple pages with “;”. If not passed, no changes will be made. | [http://www.b.com](http://www.b.com) |
...
- `-1` Direct connection- `1` socks5- `2` http- `3` https- `20` IPIDEA Proxy- `21` IPHTML Proxy- `22` kookeey Proxy- `23` Lumatuo Proxy
