...
> API Reference > Cloud Phone API Reference > File Management > Query the upload status of files to the cloud phone

**Source:** [https://doc.geelark.com/web/#/602813392/101528109](https://doc.geelark.com/web/#/602813392/101528109)

---

## API Description
Query the upload status of files to the cloud phone.You can actively retrieve the result within one hour of initiating the upload task; after expiration, the retrieval will fail.
