...
> API Reference > Cloud Phone API Reference > Cloud Phone Management > Create new V2

**Source:** [https://doc.geelark.com/web/#/602813392/101528476](https://doc.geelark.com/web/#/602813392/101528476)

---

## API Description

- The Basic plan supports the creation of only one cloud phone at a time, while the Pro plan supports batch creation.- Supports model selection. Please first call [the cloud phone brand list interface](https://open.geelark.cn/web/#/602813392/101528264) to obtain supported brand model information.- Proxy information, added proxy, dynamic proxy must specify one, added proxy is used first, followed by proxy information.
...
| --- | --- | --- | --- | --- |
| mobileType | Yes | string | Cloud phone type, can be setAndroid 9Android 10Android 11 Android 12 Android 13 Android 14 Android 15 | Android 10 |
...
| refreshUrl | No | string | Proxy refresh url | [http://someaddr](http://someaddr) |
| proxyNumber | No | integer | The serial number of the added proxy | 1 |
| dynamicProxy | No | string | Saved dynamic proxy, can be set IPIDEA/IPHTML/kookeey/Luminati(BrightData)/rolaip/Proxyma/DECODO/NodeMaven/IPIDEAMobile/kookeeyMobile | IPIDEA |
...
#### equipmentInfo Cloud phone equipment info 
