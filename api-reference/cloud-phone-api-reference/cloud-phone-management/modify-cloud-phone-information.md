...
> API Reference > Cloud Phone API Reference > Cloud Phone Management > Modify cloud phone information

**Source:** [https://doc.geelark.com/web/#/602813392/101527935](https://doc.geelark.com/web/#/602813392/101527935)
...
- Modify cloud phone information.- Support modifying the cloud phone name.- Support modifying the cloud phone remark.- Support modifying the cloud phone tags.- Support modifying the cloud phone proxy configuration.- Support modifying the cloud phone group.- Support modifying the cloud phone charge mode.
...
- `1` : socks5- `2` : http- `3` : https

### 2. Dynamic Proxy List

- `20` IPIDEA- `21` IPHTML- `22` kookeey- `23` Lumatuo
...
### failDetails Tag Addition Failure Info 
