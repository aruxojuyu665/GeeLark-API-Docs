...
> API Reference > Cloud Phone API Reference > Cloud Phone Management > Get screen shot result

**Source:** [https://doc.geelark.com/web/#/602813392/101528206](https://doc.geelark.com/web/#/602813392/101528206)

---

## API Description
Query the status of cloud phone screenshot taskAfter requesting a screenshot, you can actively obtain the result through this interface within 30 minutes. If it expires, the retrieval will fail
