...
> API Reference > Proxy Management > Delete proxy

**Source:** [https://doc.geelark.com/web/#/602813392/101527928](https://doc.geelark.com/web/#/602813392/101527928)
...
| Parameter Name | Type | Description || id | string | Proxy ID || code | integer | Error code, refer to failure code and message || msg| string | Error message, refer to failure code and message |
...
## Error Codes
Please refer to the [API Call Documentation](https://showdoc.geelark.com/web/#/602813392/101527834).