...
> API Reference > Proxy Detection > Proxy Detection

**Source:** [https://doc.geelark.com/web/#/602813392/101528662](https://doc.geelark.com/web/#/602813392/101528662)
...
| --- | --- | --- | --- | --- |
| detect_type | Yes | string | IP lookup source, supports only `IP-API` or `IP2Location` | IP2Location |
| proxy_type | Yes | string | Proxy type, supports only `socks5`, `http`, or `https` | socks5 |
...
## Error Codes
Please refer to the [API Call Documentation](https://showdoc.geelark.cn/web/#/602813388/101527801)